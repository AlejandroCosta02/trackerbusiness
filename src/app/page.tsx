...
export default function Home() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-gradient-to-b from-indigo-50 via-white to-indigo-50 relative">
      ...
      <div className="relative z-1 h-full flex flex-col pt-8">
        {/* Hero Section */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="relative group">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm px-8 py-7 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-indigo-50 h-[180px] flex flex-col">
