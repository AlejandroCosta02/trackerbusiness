  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="relative h-screen overflow-hidden bg-white">
        ...
        <div className="absolute top-1/4 -left-48 w-96 h-96 bg-indigo-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob" />
        <div className="absolute top-1/3 -right-48 w-96 h-96 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob delay-2000" />
        <div className="absolute -bottom-32 left-1/2 transform -translate-x-1/2 w-96 h-96 bg-pink-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob delay-4000" />
        ...
        <div className="relative z-10 h-full flex flex-col pt-8">
          ...
          <div className="flex-1 w-full mt-16 flex items-center">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-white shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 rounded-2xl p-8 h-[200px] flex flex-col">
                    ...
                    <p className="text-sm text-gray-600 line-clamp-2">Track and optimize your returns with comprehensive investment monitoring and analysis tools.</p>
                  </div>
                </div>
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-white shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 rounded-2xl p-8 h-[200px] flex flex-col">
                    ...
                    <p className="text-sm text-gray-600 line-clamp-2">See where your money goes at a glance with intuitive expense tracking and categorization.</p>
                  </div>
                </div>
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-white shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 rounded-2xl p-8 h-[200px] flex flex-col">
                    ...
                    <p className="text-sm text-gray-600 line-clamp-2">Make data-driven decisions to grow your business with real-time profit analytics and insights.</p>
                  </div>
                </div>
              </div>
            </div>
